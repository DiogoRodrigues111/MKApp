...
public:
	...
	void Init_USART();
	void SendCmd(USART_INFO_ABSTRATION_CXX addrSignature, void* addrValue);
	void RecvCmd(USART_INFO_ABSTRATION_CXX addrSignature, void* addrValue);
#endif // USE_WITHOUT_HAL_ST
private:
	uint8_t* m_u8pUart_test = (volatile uint8_t)0x2C;
	const char* m_strUartTest = "Hello, Uart";
};
#endif // __cplusplus
